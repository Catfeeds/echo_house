...
class PlotExt extends Plot{
    ...
    public function relations()
    {
        return array(
            ...
            'sfMarkets'=>array(self::HAS_MANY, 'PlotMarketUserExt', 'hid','condition'=>'sfMarkets.deleted=0 and sfMarkets.status=1 and sfMarkets.expire>'.time(),'order'=>'places.created desc'),
