 ...
 * @property integer $can_sub
 * @property integer $vip_expire_new
...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parent, can_sub, vip_expire_new, is_jl, is_manage, is_true, refresh_num, qf_uid, cid, vip_expire, type, status, deleted, sort, created, updated', 'numerical', 'integerOnly'=>true),
			...
			array('id, pwd, wx, phone, name, parent, jjq_openid, openid, can_sub, vip_expire_new, is_jl, is_manage, is_true, id_nation, id_birth, id_addr, id_no, id_pic, subs_id, virtual_no_ext, virtual_no, refresh_num, qf_uid, cid, vip_expire, company, type, ava, image, status, deleted, sort, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('can_sub',$this->can_sub);
		$criteria->compare('vip_expire_new',$this->vip_expire_new);
