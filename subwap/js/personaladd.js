...
$(document).ready(function() {
    ...
    $.get('/api/tag/publishtags',function(data) {
        ...
        for(var i=0;i<tags[0].list.length;i++){
          $('#wylx').append('<li><input class="box wylx" name="wylx[]" type="checkbox" value="'+tags[0].list[i].id+'"><div class="box-text">'+tags[0].list[i].name+'</div></li>');
        }
        for(var i=0;i<tags[1].list.length;i++){
          $('#zxzt').append('<li><input class="box zxzt" name="zxzt[]" type="checkbox" value="'+tags[1].list[i].id+'"><div class="box-text">'+tags[1].list[i].name+'</div></li>');
        }
        ...
        for(var i in tags[4].list){
          $('#mode').append('<li><input class="box" name="dllx" type="radio" value="'+i+'"><div class="box-text">'+tags[4].list[i]+'</div></li>');
        }
    }); 
});
