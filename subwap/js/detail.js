        ...
        if(data.data.is_user == true) {
            ...
            if(detail.phones.length > 0) {
                for (var i = 0; i < detail.phones.length; i++) {
                    ...
                    // debugger;
                    $('.telephone-consult ul').append('<li><a href="tel:'+detail.phonesnum[i]+'"><div class="telephone-place"><img class="consult-user-img" src="./img/'+icon+'"><div class="consult-text">'+detail.phones[i]+word+'</div><div onclick="setChat(this)" data-text="'+detail.thatuid+'" class="copy-weixin">在线聊天</div><img class="consult-tel-img" src="./img/tel-green.png"></div><div class="line"></div></a></li>');
                }
            }
