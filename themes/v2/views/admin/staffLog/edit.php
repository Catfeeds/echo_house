...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'pay_type', StaffLogExt::$paytype, array('class' => 'form-control', 'encode' => false)); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'pay_type') ?></div>
</div>
